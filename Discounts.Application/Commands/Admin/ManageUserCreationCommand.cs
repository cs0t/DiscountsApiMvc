...
public sealed record ManageUserCreationCommand
    (string UserName, string Email, string Password, string ConfirmPassword, int RoleId) : IRequest<int>, IRequireRole
{
